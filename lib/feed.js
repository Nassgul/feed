...
var GENERATOR = "Godzilist's Feed";
...
var Feed = function () {
    ...
    _createClass(Feed, [{
        ...
        value: function atom1() {
            ...
            if (options.image) {
                feed.push({ logo: [{_attr: { href:options.image }}]});
            }
            ...
            this.items.forEach(function (item) {
                ...
                var entry = [{ title: { _attr: { type: 'html' }, _cdata: item.title } }];
                ...
                if (item.image) {
                    entry.push({ enclosure:[{ _attr: { href: item.image } }] });
                }
                // entry author(s)
        ...
        value: function rss2() {
            ...
            this.items.forEach(function (entry) {
                ...
                if (entry.link) {
                    item.push({  link: [{ _attr: { href: entry.link } }] });
                }
